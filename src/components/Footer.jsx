...
const Footer = () => {
  return (
    <footer className="bg-white border-t border-gray-200 mt-[100px] absolute bottom-[-999] w-[100%]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center space-y-8 lg:space-y-0">
          ...
          <div className="flex flex-col md:flex-row  md:space-x-16  lg:space-y-0">
            <div>
              <h4 className="font-semibold mb-4">Errands Connect</h4>
            ...
            <div>
              <h4 className="font-semibold mb-4">Partner with Errands Connect</h4>
              <ul className="space-y-2 text-sm">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-center mt-8">
          ...
          <div className="flex space-x-4">
            <button className="bg-gray-200 py-2 px-4 rounded-full text-sm hover:bg-gray-300">
              Get the Errand Connect app
            </button>
            <button className="bg-gray-200 py-2 px-4 rounded-full text-sm hover:bg-gray-300">
              Get the Errand Connect Driver app
            </button>
          </div>
        </div>
        ...
        <div className="border-t border-gray-200 mt-8 pt-4">
          <p className="text-sm text-gray-500 text-center">&copy; 2024 Errand Connect</p>
          <div className="flex justify-center space-x-4 mt-2">
            <a href="#" className="text-sm text-gray-500 hover:text-gray-700">Suppliers</a>
            <a href="#" className="text-sm text-gray-500 hover:text-gray-700">Terms & Conditions</a>
